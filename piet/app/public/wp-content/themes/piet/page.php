    ...
    <?php $parentId = wp_get_post_parent_id(get_the_ID());
      ...
      <div class="metabox metabox--position-up metabox--with-home-link">
        <p>
          ...
          <a class="metabox_blog-home-link" href="<?php echo get_permalink($parentId);?>"><i class="fa fa-home" aria-hidden="true"></i> Back to <?php echo get_the_title($parentId); ?></a> <span class="metabox_main"><?php echo the_title();?></span>
        </p>
      </div>
      <?php } ?>
