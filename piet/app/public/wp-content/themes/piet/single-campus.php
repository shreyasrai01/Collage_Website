...
<div class="generic-content">
   <div class="metabox metabox--position-up metabox--with-home-link">
        <p>
           <a class="metabox__blog-home-link" href="<?php echo site_url('/campus');?>"><i class="fa fa-home" aria-hidden="true"></i>ALL CAMPUSES </a> 
            </span>
        </p>
    </div>
<?php the_content(); ?>
...
?>
   ...
   <h2 class="headline headline--medium">THIS IS CAMPUSES</h2>
